...
public class UserControler {
    ...
    public String searchPlayer(@Valid SearchDto dto, BindingResult result, Model model) throws RegisterFailedException {
        ...
        try {
            ...
            System.out.println("error pliku");
                ...
                try {
                    ...
                    FTPClient ftpClient = FtpClient.open("62.21.98.152",21,"Miri@da_24347","Miriada33");
